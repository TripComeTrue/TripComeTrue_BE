...
public class TripRecordService {
    ...
    public TripRecordDetailResponseDto findTripRecord(Long tripRecordId) {
        ...
        TripRecordDetailResponseDto responseDto = TripRecordDetailResponseDto.fromEntity(
            findTripRecord);
    ...
    @Transactional
    public TripRecordResponseDto modifyTripRecord(PrincipalDetails principalDetails,
        Long tripRecordId, TripRecordRequestDto requestDto) {
